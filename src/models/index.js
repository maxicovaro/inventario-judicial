...
Insumo.hasMany(StockOficina, { foreignKey: "insumo_id" });
StockOficina.belongsTo(Insumo, { foreignKey: "insumo_id" });

Oficina.hasMany(StockOficina, { foreignKey: "oficina_id" });
StockOficina.belongsTo(Oficina, { foreignKey: "oficina_id" });

Oficina.hasMany(ConsumoOficina, { foreignKey: "oficina_id" });
ConsumoOficina.belongsTo(Oficina, { foreignKey: "oficina_id" });

Insumo.hasMany(ConsumoOficina, { foreignKey: "insumo_id" });
ConsumoOficina.belongsTo(Insumo, { foreignKey: "insumo_id" });

Usuario.hasMany(ConsumoOficina, { foreignKey: "usuario_id" });
ConsumoOficina.belongsTo(Usuario, { foreignKey: "usuario_id" });
