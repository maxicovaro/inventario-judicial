...
assert.match(migration, /addColumnIfMissing\(queryInterface, "oficinas", "gestiona_deposito"/);
assert.match(migration, /addColumnIfMissing\(queryInterface, "oficinas", "es_deposito_central"/);
...
console.log("P9.2A - contratos de Depósito Central validados correctamente.");
